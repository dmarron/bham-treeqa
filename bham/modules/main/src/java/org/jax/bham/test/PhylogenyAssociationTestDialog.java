...
public class PhylogenyAssociationTestDialog extends JDialog
{
    ...
    private void postGuiInit()
    {
        ...
        {
            this.genomeDataSourceComboBox.addItem(genoDataSrc);
        }
   ...
   /**
    ...
    {
        return (GenomeDataSource)this.genomeDataSourceComboBox.getSelectedItem();
    }
    ...
    private boolean validateData()
    {
        ...
        if(errorMessage == null)
        {
            ...
            Set<String> genomeStrains = this.getSelectedGenomeDataSource().getAvailableStrains();
	...
	javax.swing.JLabel genomeDataSourceLabel = new javax.swing.JLabel();
        genomeDataSourceComboBox = new javax.swing.JComboBox();
	...
	genomeDataSourceLabel.setText("Genome Data:");
		    ...
		    //.add(genomeDataSourceLabel))
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .add(layout.createSequentialGroup()
                        .add(genomeDataSourceComboBox, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
        );
    ...
    private javax.swing.JComboBox genomeDataSourceComboBox;
